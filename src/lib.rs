...
#[derive(Debug)]
pub struct NexusProProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NexusProProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NexusPro processing");
    
    let mut processor = NexusProProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NexusProProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NexusProProcessor::new(false);
